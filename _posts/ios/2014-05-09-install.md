...
It is recommended to have separate app ids for development and production. Swapping between them can be accomplished automatically by using preprocessing macros.
