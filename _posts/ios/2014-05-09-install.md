...
It is recommended to have separate app ids for development and production. This is because it will keep all new changes in a sandbox for development, and those changes won't pollute your production version.  

Swapping between them can be accomplished automatically by using preprocessing macros.
