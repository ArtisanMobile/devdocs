...
<div class="note note-hint">
  <p>NOTE: By default the installer is going to add support for Google Cloud Messaging and Artisan Push. If you would not like to use Artisan Push or Google Cloud Messaging you should add the --nopush option when running the installer script, like this:</p>
  <ul>
...
1\. implement **protected void onCreate(Bundle savedInstanceState)** and call **ArtisanActivity.artisanOnCreate(this)**
...
2\. Add or update an implementation for **protected void onStart()** and call **ArtisanActivity.artisanOnStart(this)**
...
3\. Add or update an implementation for **protected void onStop()** and call **ArtisanActivity.artisanOnStop(this)**
...
4\. Add or update an implementation for **protected void onDestroy()** and call **ArtisanActivity.artisanOnDestroy()**
...
5\. Add an implementation for the version of setContentView that you are using in this Activity and call the corresponding version of **ArtisanActivity.artisanGetContentView** to get the updated contentView
