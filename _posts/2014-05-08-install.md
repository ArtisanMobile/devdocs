...
* Artisan depends on the Android v4 Support Library. This can be added to your gradle dependencies with <strong>compile 'com.android.support:support-v4:21.0.+'</strong>. For non-gradle projects if you do not already have the v4 support library in your project you can find a copy of android-support-v4.jar in the downloaded artisan/Support directory or in your local install of the Android SDKs extras/android/support/v4 directory.
