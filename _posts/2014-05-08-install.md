...
2\. Extract YOURAPPNAME-ArtisanInstaller.zip and move the <strong>artisan</strong> folder into your project's root directory.
...
<div class="note note-hint">
  ...
  <div class="padding-left-20">
    ...
    <p>1. Extract the contents of YOURAPPNAME-ArtisanInstaller.zip into your project's root directory if you didn't do that in step 2 above. Now you should have a folder named "artisan" in the same folder with your AndroidManifest.xml</p>
