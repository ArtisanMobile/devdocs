...
The Event Report provides visibility into the actions triggered by users within your app (e.g. screens viewed, buttons tapped, events instrumented via the [Artisan Event Tracking API]({% post_url 2014-05-08-event-tracking %}), etc.).  
