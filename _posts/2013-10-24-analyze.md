...
* User Segment (see [People & Segmentation]({% post_url 2014-06-11-people %}))
* Date Range
* Device Chararacteristics, including:
    ...
    * Device Language
    * User Country
* User Experiment Variation (for users who have participated in an A/B Test, see [Experiments]({% post_url 2013-10-24-optimize %}))
* User Campaign (for users who had been engaged in a campaign, see [Campaigns]({% post_url 2014-06-10-campaigns %}))
...
The Event Report provides visibility into the actions triggered by users within your app (e.g. screens viewed, buttons tapped, events instrumented via the [iOS]({% post_url 2014-05-09-event-tracking %}), [Android]({% post_url 2014-05-08-event-tracking %}) or [Javascript]({% post_url 2014-07-18-hybrid-sdk-reference-guide %}#trackingapi) Event Tracking APIs, etc.).  
...
Additionally, events can be manually collected via the [Artisan Event Tracking API]({% post_url 2014-05-08-event-tracking %}). This API is available for capturing events triggered within the business logic of your app or events not automatically collected by Artisan.
