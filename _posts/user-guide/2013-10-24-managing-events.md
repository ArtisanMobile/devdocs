...
The Artisan Event Tracking API can also add context tags and categories to the information that Artisan tracks.  These tags and categories can be used to filter the event report, as well as to see a breakdown of how often a given tagged event occurs in the wild.
...
<p><img src="/images/screens/reports-tag-family-1246x1233.gif" width="700" height="693" alt="Screen capture of how to create tagged families." /></p>
