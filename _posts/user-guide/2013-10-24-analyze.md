...
* Recency
* Frequency
* Events (see [Managing Events](#events))
* Retention
...
The Event Report shows all of the actions that have ever been triggered within your app, along with their tagged information and frequency per user.  See [Managing Events](#events) for more information.
